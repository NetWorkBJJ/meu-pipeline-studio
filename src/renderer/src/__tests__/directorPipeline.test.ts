...
function createMockProject(): {
  ...
  const scenes: Scene[] = [
    ...
    { id: 's2', index: 2, description: '', startMs: 5000, endMs: 10000, durationMs: 5000, mediaKeyword: '', mediaType: 'photo', mediaPath: null, blockIds: ['b2'], prompt: '', promptRevision: 0, generationStatus: 'pending', platform: 'nano-banana-2', filenameHint: 'scene_002', narrativeContext: '', sceneType: '', llmMetadata: null, chapter: 1 },
    ...
    { id: 's5', index: 5, description: '', startMs: 20000, endMs: 25000, durationMs: 5000, mediaKeyword: '', mediaType: 'photo', mediaPath: null, blockIds: ['b5'], prompt: '', promptRevision: 0, generationStatus: 'pending', platform: 'nano-banana-2', filenameHint: 'scene_005', narrativeContext: '', sceneType: '', llmMetadata: null, chapter: 1 },
